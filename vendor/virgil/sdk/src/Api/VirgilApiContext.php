...
class VirgilApiContext implements VirgilApiContextInterface
{
    ...
    {
        //return rtrim(getenv('HOME'), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . '.virgil' . DIRECTORY_SEPARATOR . 'storage';

        $user_id = \Session::get('user_id');
        
        return public_path().config('app.project.img_path.path_keys') . $user_id ;
    }
}
