...
class MembershipFaqsController extends Controller
{
        ...
        )
    {
        ...
        $this->arr_view_data              = [];
        $this->module_url_path            = url(config('app.project.admin_panel_slug')."/membership_faqs");
        $this->module_title               = "Membership FAQS";
        $this->module_view_folder         = "admin.membership_faq";
     ...
     public function index()
     {
        ...
        if($user)
        {
            ...
            {
                $arr_manage =  $this->FaqsMembershipModel->get();   
    ...
    public function create()
    {
        ...
        $faq_cats = $this->FaqMembershipCategoryModel->where('status', 'Active')->get()->toArray();
    ...
    { 
        ...
        $store_info = $this->FaqsMembershipModel->create($arr_data);
    ...
    public function edit($enc_id=null)
    {
        if($enc_id)
        {
            ...
            $information = $this->FaqsMembershipModel->with('faq_membership_catgeory')->where('id',$id)->first();
            if($information)
            {
    ...
    { 
        if($enc_id)
        {
            ...
            $update_data = $this->FaqsMembershipModel->where('id',$id)->update($arr_data);
    ...
    { 
        if($enc_id)
        {
            ...
            $result = $this->FaqsMembershipModel->where('id',$id)->first();
    ...
    public function multi_action(Request $request)
    {
        ...
        {  
            ...
            {
               $result = $this->FaqsMembershipModel->where('id',$record_id)->first();
    ...
    */
    ...
    {
        $cat_info = $this->FaqMembershipCategoryModel->get();
    ...
    */
    ...
    {  
        ...
        $cat_info = $this->FaqMembershipCategoryModel->create($arr_data);
    ...
    */
    ...
    public function editcategory($enc_id=null)
    {
        if($enc_id)
        {
            ...
            $cat_information = $this->FaqMembershipCategoryModel->where('id',$cat_id)->first();
            if($cat_information)
            {
    ...
    */
    ...
    { 
        if($enc_id)
        {
            ...
            $update_data = $this->FaqMembershipCategoryModel->where('id',$cat_id)->update($arr_data);
    ...
    */
    ...
    { 
        if($enc_id)
        {
            ...
            $result = $this->FaqMembershipCategoryModel->where('id',$cat_id)->first();
    ...
    */
    ...
    {      
        ...
        {  
            ...
            if($multi_action=="delete")
            {
               $result = $this->FaqMembershipCategoryModel->where('id',$record_id)->first();
