...
@section('main_content')
            ...
            <div class="col-sm-12 col-md-9 col-lg-10">
               <div class="das-middle-content">
                  <div class="row">
                    ...
                    <form method="post" action="{{ $module_url_path }}/update_password" enctype="multipart/form-data" id="frm_doctor_change_password" name="frm_doctor_change_password"> 
                    {{ csrf_field() }}
                            ...
                            <div class="uer-bxx">
                              <div class="row">
                                 <div class="col-sm-12 col-md-4 col-lg-2">
                                    <div class="frm-label">Change Password <span style="color:red;">*</span></div>
                                 </div>
    ...
    $(document).ready(function(){
      ...
      $('#frm_doctor_change_password').validate({
