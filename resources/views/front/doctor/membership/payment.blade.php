                    ...
                    <div class="z-depth-3 round-box">
                        ...
                        <div class="round-box-content">
                            ...
                            <div class="row membership-text">
                                ...
                                <div class="col s6" id="membership_amt">{{isset($membership_plan_arr['monthly_amount']) ? '$'.number_format($membership_plan_arr['monthly_amount'], 2, '.', '') : '' }}</div>
                            </div>
                                                ...
                                                success:function(result){
                                                    ...
                                                    if(data[0] == 'error'){
                                                      ...
                                                      return false;          
                                                        ...
                                                        var gst_amt = base_price * 0.10;
                                                        var grand_total = new_price + gst_amt;

                                                        $('#total_amt').html('$'+grand_total.toFixed(2));
                                                        $('#membership_price').val(grand_total.toFixed(2));
                        ...
                        <?php
                            $monthly_amount = isset($membership_plan_arr['monthly_amount']) ? $membership_plan_arr['monthly_amount'] : '';
                            $grand_total = add_gst($monthly_amount);
                        ?>
                        <div class="heading-round-box-green">
                            <div class="row">
                                <div class="col s6 right-align">Total</div>
                                <div class="col s6 left-align" id="total_amt">{{'$'.number_format($grand_total, 2, '.', '')}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="z-depth-3 round-box">
                ...
                <div class="col l8 s12">
                    <div class="z-depth-3 round-box">
                        ...
                        <div class="round-box-content">
                            ...
                            @php
                                $monthly_amount = isset($membership_plan_arr['monthly_amount']) ? $membership_plan_arr['monthly_amount'] : '';
                                $total_monthly_amount = isset($membership_plan_arr['total_monthly_amount']) ? $membership_plan_arr['total_monthly_amount'] : '';

                                $monthly_discount = isset($membership_plan_arr['monthly_discount']) ? $membership_plan_arr['monthly_discount'].'%' : '';

                                $annually_amount = isset($membership_plan_arr['annually_amount']) ? $membership_plan_arr['annually_amount'] : '';
                                $total_annually_amount = isset($membership_plan_arr['total_annually_amount']) ? $membership_plan_arr['total_annually_amount'] : '';
                                    ...
                                    <ul class="payment-option">
                                        <li>
                                            <div class="radio-input">
                                                ...
                                                <label for="monthly">Monthly - {{ '$'.number_format($monthly_amount, 2, '.', '') }}
                                        ...
                                        <li>
                                            <div class="radio-input">
                                                ...
                                                <label for="annual" class="left-100px-pad">Annually - {{ '$'.number_format($annually_amount, 2, '.', '') }} <small>Billed every 6 months</small>
                            ...
                            <div class="note-security">
                                ...
                                <p>You authorise doctoroo to charge your card on the subscription period until your membership is cancelled. <a href="{{ url('/') }}/doctor/settings/healthcare-provider-marketplace-terms-condition" class="green-text" target="_blank">Full terms available here.</a> </p>
                            </div>
                        </div>
        ...
        $(document).ready(function(){
            ...
            $('.package').change(function(){
                ...
                if(membership_package == 'annually')
                {
                   ...
                   var base_amt = {{ isset($membership_plan_arr['annually_amount']) ? $membership_plan_arr['annually_amount'] : '' }};
                ...
                else if(membership_package == 'monthly')
                {
                   ...
                   var base_amt = {{ isset($membership_plan_arr['monthly_amount']) ? $membership_plan_arr['monthly_amount'] : '' }};
                   var total_amt = {{ isset($membership_plan_arr['total_monthly_amount']) ? $membership_plan_arr['total_monthly_amount'] : '' }};
                }

                var gst_amt = base_amt * 0.10;
                var grand_total = base_amt + gst_amt;

                $('#membership_amt').html('$'+membership_amt.toFixed(2));
                $('#txt_membership_base_price').val(membership_amt.toFixed(2));
                $('#voucher_code').html(voucher_code);
                $('#gst_amt').html(gst+'%');
                $('#txt_membership_base_gst').val(gst);
                $('#package_type').html(package_type);
                $('#total_amt').html('$'+grand_total.toFixed(2));
                $('#gst_price').val(gst_amt.toFixed(2));
                $('#base_price').val(base_amt.toFixed(2));
                $('#membership_price').val(grand_total.toFixed(2));
