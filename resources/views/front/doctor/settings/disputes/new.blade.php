...
@section('main_content')
        ...
        <div class="medi">
            <ul class="tabs tabli nomr z-depth-2 tabs-fixed-width">
                <li class="tab truncate">
                    <a href="{{ url('/') }}/doctor/settings/disputes" class="active redirect_new">New Disputes</a>
                </li>
                <li class="tab truncate">
            ...
            <div id="new-dispute" class="tab-content">
                ...
                @endif
                <a class="waves-effect waves-light futbtn space-btn-bottom" href="#open_disputes">Open New Dispute</a>
            </div>
    ...
    <div id="open_disputes" class="modal addperson full-app date-modal" style="display:none;">
        ...
        $(document).ready(function(){
            ...
            $('#submit_form').click(function(){
                ...
                else
                {
                    ...
                    $.ajax({
                        url: '{{ url("/") }}/doctor/settings/disputes/store',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            _token: token,
            ...
            $('#cmbconsultid').change(function(){
                    ...
                    $.ajax({
                        url: '{{ url("/") }}/doctor/settings/disputes/against_user',
                        type: 'get',
                        dataType: 'json',
