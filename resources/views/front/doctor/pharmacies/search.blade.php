        ...
        <div class="consultation-content posrel pdtbrl minhtnor has-footer">
            <div class="consultation-guide">
                <div class="head-medical-pres">
                    ...
                    <span class="posleft qusame rescahnge hide-on-med-and-down"><a href="{{ url('/') }}/doctor/pharmacies" class="border-btn btn round-corner center-align "> &lt; Back</a></span>
                </div>
                <div class="">
                ...
                <div class="width-340 left">
                    ...
                    <div class="round-box z-depth-3">
                        ...
                        <div class="green-border round-box-content pharmacy-list">
                            ...
                            <div class="paginaton-block-main" id="update_pagination"> {{ $paginate->appends(Input::except('page'))->links() }} </div>
                            <div class="clr"></div>
                        </div>
