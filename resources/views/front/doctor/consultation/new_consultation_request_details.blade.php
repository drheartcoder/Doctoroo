                    ...
                    <div class="past-consultaton-white">
                        ...
                        <div class="row consultation-id-main">
                            ...
                            <div class="col l5 m5 s5">
                                <div class="consultation-id-block">
                                    <div class="consultation-id-label">
                                        @if(isset($arr_family_member) && !empty($arr_family_member))
                                            @php
                                                $pat_title      = isset($arr_family_member['title'])?$arr_family_member['title']:'';
                                                $pat_first_name = isset($arr_family_member['first_name'])?$arr_family_member['first_name']:'';
                                                $pat_last_name  = isset($arr_family_member['last_name'])?$arr_family_member['last_name']:'';
                                            @endphp
                                        @else
                                            @php
                                                $pat_title      = isset($arr_booking['patient_user_details']['title'])?$arr_booking['patient_user_details']['title']:'';
                                                $pat_first_name = isset($arr_booking['patient_user_details']['first_name'])?$arr_booking['patient_user_details']['first_name']:'';
                                                $pat_last_name  = isset($arr_booking['patient_user_details']['last_name'])?$arr_booking['patient_user_details']['last_name']:'';
                                            @endphp
                                        @endif
                                        {{ $pat_title.' '.$pat_first_name.' '.$pat_last_name }}
                                    </div>
                                    <div class="consultation-id-content">
                                        Consulting Patient
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){  
            ...
            $('.change_booking_status').click(function(){
                ...
                {
                 status = 'Decline';
                 $('#status_message').html("Are you sure you want to decline this consultation?");  
                }
                else
                {
                    status = '';
