                   ...
                   <div class="col-sm-12 col-md-12 col-lg-9">
                     ...
                     <div class="content res-full-tab" style="background:none;">
                      <div id="one">
                          <div class="tab-section"> 
                            ...
                            <form action="{{ $module_doctor_path }}/invitation/create_doctor_invitation" method="post" name="frm_invite_doctor" id="frm_invite_doctor">
                            {{ csrf_field() }}
                      ...
                      <div id="two">
                          <div class="tab-section"> 
                             ...
                             <form action="{{ $module_doctor_path }}/invitation/create_pharmacy_invitation" method="post" name="frm_invite_pharmacy" id="frm_invite_pharmacy">
                              {{ csrf_field() }}
                                 ...
                                 <div class="pharma-step-bx">       
                                      <div class="pharma-step-content">
                                           ...
                                           <div class="user_box">
                                              ...
                                              <input type="text" class="input_acct-logn" value="{{ $arr_invitation['reg_doctor_email'] or '' }}" data-rule-required="true" data-rule-email="true" name="email_id" placeholder="Doctor Email">
                                               <span class='error'>{{ $errors->first('email_id') }}</span>
                     ...
                     {{--  third section --}}
                      <div id="three">
                          ...
                          <form action="{{ $module_doctor_path }}/invitation/create_patient_invitation" method="post" name="frm_invite_patient" id="frm_invite_patient">
                            {{ csrf_field() }}
                             ...
                             <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="pharma-step-bx" >       
                                   <div class="pharma-step-content" style="margin-top:15px !important;">
                                     ...
                                     <div class="user_box">
                                        <input type="text" class="input_acct-logn" value="" data-rule-required="true"   data-rule-email="true" name="email_id" placeholder="Patient Email">
                                         <span class='error'>{{ $errors->first('email_id') }}</span>
                                     </div>

                                     <div class="user_box">
                                         <input type="text" class="input_acct-logn" value="{{ $arr_invitation['reg_doctor_address'] or '' }}" name="address" placeholder="Address/suburb">
                                         <span class='error'>{{ $errors->first('address') }}</span>

                                    </div>
                                    <div class="user_box request-details-bx">
                                      <div class="check-box pharmacy-signup2">
                                        <input type="checkbox" class="css-checkbox" name="is_general_practitioner" value=1 id="checkbox7" tabindex="3"/>
                                          <label class="css-label lite-red-check remember_me" for="checkbox7">I'm the Normal GP of this patient
                                          </label>
                                       </div>
                                    </div>
                                  </div>
