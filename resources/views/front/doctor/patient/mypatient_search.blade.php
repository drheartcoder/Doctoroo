                    ...
                    <div class="table-row heading hidden-xs">
                        ...
                        @foreach($patients_arr['data'] as $val)
                            <div class="table-row content-row-table">
                                ...
                                <div class="table-cell transaction-status view-details-btn"><a href="{{ url('/') }}/doctor/patients/details/{{ base64_encode($val['userinfo']['id']) }}">View details</a></div>
                            </div>            
                        @endforeach
                </div>
                @else
        ...
        $('#doctor_name').keyup(function(e){
            ...
            if(doc_keyword != '')
            {
                $.ajax({
                    ...
                    type:'get',
                    data:{doc_keyword:doc_keyword,patient_type:'myown'},
