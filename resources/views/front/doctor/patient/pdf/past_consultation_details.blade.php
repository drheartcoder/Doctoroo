            ...
            @if(isset($past_consultation_arr) && $past_consultation_arr['familiy_member_info'] == null)
                ...
                <tr style="font-size:11pt;">
                    <td><strong>Phone No. :</strong> 
                        {{isset($past_consultation_arr['patient_info']['phone_no']) ? $past_consultation_arr['patient_info']['phone_no'] : '' }}
                    </td>
                    <td><strong>Mobile No. :</strong>  
                        {{isset($past_consultation_arr['patient_info']['mobile_no']) ? $past_consultation_arr['patient_info']['mobile_no'] : '' }}
                    </td>
                </tr>
                <tr style="font-size:11pt;">
                    <td colspan="2"><strong>Address :</strong> 
                        {{isset($past_consultation_arr['patient_info']['suburb']) ? $past_consultation_arr['patient_info']['suburb'] : '' }}
                    </td>
                </tr>
    ...
    <tr>
        <td>
            <table width="100%" cellspacing="0" cellpadding="10">
                ...
                <tr style="font-size:11pt;">
                    <td width="50%"> <strong>Consulting Docotr :</strong> @if(isset($past_consultation_arr['doctor_user_details']))
                     {{isset($past_consultation_arr['doctor_user_details']['title']) ? $past_consultation_arr['doctor_user_details']['title'] : ''}} {{isset($past_consultation_arr['doctor_user_details']['first_name']) ? $past_consultation_arr['doctor_user_details']['first_name'] : ''}} {{isset($past_consultation_arr['doctor_user_details']['last_name']) ? $past_consultation_arr['doctor_user_details']['last_name'] : ''}}
                    @endif</td>
    ...
    <tr>
        <td>
            <table width="100%" cellspacing="0" cellpadding="10">
                ...
                <tr style="font-size:11pt;">
                    <td>
                        <p style="line-height: 16pt;">{{isset($past_consultation_arr['symptoms']) && !empty($past_consultation_arr['symptoms']) ? $past_consultation_arr['symptoms'] : 'Not available'}} 
                        </p>
                    </td>
