...
@section('main_content')
        ...
        <div id="patient" class="tab-content medi ">
            ...
            <div class="doctor-container">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="head-medical-pres" style="margin: 0 0 10px;">
                                            ...
                                            <a href="{{$module_url_path}}/patients/details/download/{{isset($patient_details[0]['user_id']) ? base64_encode($patient_details[0]['user_id']) : ''}}" id="btn_download_pdf" class="bluedoc-bg btn-floating download-ico center-align white-text circle btn file_download" entitlement_name="all details and" target="_blank"><i class="material-icons">file_download</i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col l6 s12 ">
                                        ...
                                        <div class="row ">
                                            <div class="col l6 s12 martp">
                                                <label class="doc-details">
                                                    <strong class="grey-text">Phone No. </strong> {{isset($patient_details[0]['phone_no']) ? $patient_details[0]['phone_no'] : '-' }}
                                                </label>
                                            </div>
                                            <div class="col l6 s12 martp">
                                                <label class="doc-details">
                                                    <strong class="grey-text">Mobile No. </strong> {{isset($patient_details[0]['mobile_no']) ? $patient_details[0]['mobile_no'] : '-' }}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row martp">
                                            <div class="col s12">
                                                <label class="doc-details">
                                                    <strong class="grey-text">Address. </strong>  {{isset($patient_details[0]['suburb']) ? $patient_details[0]['suburb'] : '-' }}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                @foreach($user_entitlement_arr as $entitle_val)
                                                    <div class="row ">
                                                        <div class="col l6 s12 martp posrel">
                                                            <label class="doc-details">
                                                                <strong class="grey-text">{{isset($entitle_val['user_entitlement']['entitlement']) ? $entitle_val['user_entitlement']['entitlement'] : ''}}</strong> {{isset($entitle_val['card_no']) ? $entitle_val['card_no'] : '' }}
                                                            </label>
                                                            @if($entitle_val['affect_area_img'] !='' && File::exists($patient_uploads_url.$entitle_val['affect_area_img']))
                                                                <a href="{{$patient_uploads_base_url.$entitle_val['affect_area_img']}}" download class="bluedoc-bg btn-floating download-medicare center-align white-text circle btn file_download" entitlement_name="{{isset($entitle_val['user_entitlement']['entitlement']) ? $entitle_val['user_entitlement']['entitlement'] : ''}}"><i class="material-icons">file_download</i>
                                                                </a>
                                                            @endif
                ...
                <div class="head-medical-pres" style="display: none;" id="edit_patient">
                    ...
                    <span class="posleft qusame rescahnge hide-on-med-and-down"><a href="{{URL::previous()}}" class="border-btn btn round-corner center-align">&lt; Back</a></span>
                </div>
                                    ...
                                    <div class="col l6 m12 s12">
                                        <div class="otherdetails">
                                            ...
                                            <div class="row">
                                                <div class="col l6 m6 s12">
                                                    <div class="input-field text-bx lessmar input-padding-25px">
                                                        <input type="text" id="phone_no" value="{{isset($patient_details[0]['phone_no']) ? $patient_details[0]['phone_no'] : '' }}" class="validate">
                                                        <label for="phone_no" class="grey-text truncate">Phone Number</label>
                                                    </div>
                                                </div>
                                                <div class="col l6 m6 s12">
                                                    <div class="input-field text-bx lessmar input-padding-25px">
                                                        <input type="text" id="mobile_no" value="{{isset($patient_details[0]['mobile_no']) ? $patient_details[0]['mobile_no'] : '' }}" class="validate">
                                            ...
                                            <div class="row">
                                                <div class="col l12 m12 s12">
                                                    <div class="input-field  text-bx lessmar input-padding-25px">
                                                        <input type="text" id="address" class="materialize-textarea" value="{{isset($patient_details[0]['suburb']) ? $patient_details[0]['suburb'] : '' }}">
                                                                ...
                                                                @if(isset($val['affect_area_img']) && !empty($val['affect_area_img']))    
                                                                     @if($val['affect_area_img'] !='' && File::exists($patient_uploads_url.$val['affect_area_img']))
                                                                        <div class="image-avtar left"> 
                                                                            <img src="{{$patient_uploads_base_url}}/{{$val['affect_area_img']}}" class="disp_img circle">
                                                                        </div>
                                                                     @else
                                                                        NA         
                                                                     @endif
                                    ...
                                    @if(isset($patient_details[0]['memberfamily']) && !empty($patient_details[0]['memberfamily']))
                                        ...
                                        <li class="collection-item avatar  valign-wrapper">
                                            ...
                                            <ul id='dropdown_{{$member['id']}}' class='dropdown-content doc-rop member_action_panel'>
                                                ...
                                                <input type="hidden" value="{{isset($member['date_of_birth']) ? date('d/m/Y', strtotime($member['date_of_birth']))   : ''}}" class='member_dob'>
        ...
        <form method="post" id="add_member_form" enctype="multipart/form-data">
            ...
            <div class="modal-data">
               ...
               <div class="row">
                  ...
                  <div class="col s12 m6">
                     <div class="input-field text-bx ">
                        <input id="datebirth datepicker" name="datebirth" type="date" class="datepicker dob validate">
            ...
            <div class="modal-data">
               ...
               <div class="row">
                  ...
                  <div class="col s12 m6" id="edit_date_block">
                     <div class="input-field text-bx ">
                        <input id="edit_datebirth" name="datebirth" type="date" class="datepicker dob_upd validate">
                        <label class="active" for="datebirth">Date of birth <span class="required_field">*</span></label>
                        <span class="datebirth_error"></span>
                     </div>
                  </div>
    ...
    <div id="view_member" class="modal  date-modal addperson">
            ...
            <div class="modal-footer center-align">
               <a href="javascript:void(0)" id="back_btn" class="modal-action modal-close waves-effect waves-green btn-cancel-cons">Ok</a>
                  ...
                  $.ajax({
                   ...
                   success:function(data){
                      ...
                      if(data.status == 'success')
                      {
                          ...
                          {
                            image = '<div class="image-avtar uploaded_img posrel"><img src="'+patient_uploads_base_url+'/'+data.affected_area_photo+'" value="'+data.affected_area_photo+'" class="disp_img circle affected_area_photo"><a href="javascript:void(0)" class="remove_affected_area del_image"><i class="fa fa-trash-o"></i></a></div>';
                  ...
                  $.ajax({
                   ...
                   success:function(data){
                      ...
                      if(data.status == 'success')
                      {
                          ...
                          if(data.affected_area_photo !='')
                          {
                            image = '<div class="image-avtar left"><img src="'+patient_uploads_base_url+'/'+data.affected_area_photo+'" value="'+data.affected_area_photo+'" class="disp_img circle affected_area_photo"><a href="javascript:void(0)" class="remove_affected_area"><i class="fa fa-times"></i></a></div>';
                             $('#affected_area_img_section').html(image);  
                          }
                          else
                          {
    ...
    $(document).ready(function(){
       ...
       $('.edit_member').click(function(){
            ...
            $('#edit_firstname').val($(this).closest('.member_action_panel').find('.member_fname').val());

            $('#edit_lastname').val($(this).closest('.member_action_panel').find('.member_lname').val());

            $('#edit_member_email').val($(this).closest('.member_action_panel').find('.member_email').val());

            $('#edit_contact_no').val($(this).closest('.member_action_panel').find('.member_mobile_no').val());

            $('#edit_datebirth').val($(this).closest('.member_action_panel').find('.member_dob').val());
                   
            gender = $(this).closest('.member_action_panel').find('.member_gender').val()

            $('.edit_gender').find('.select-dropdown').val(gender);

            $('#edit_gender').val(gender).attr('selected','selected');    

            $('#edit_password').val($(this).closest('.member_action_panel').find('.member_relationship').val());
            
            $('#edit_member_id').val($(this).closest('.member_action_panel').find('.member_id').val());
        ...
        $('.view_member').click(function(){
            ...
            $('#view_firstname').val($(this).closest('.member_action_panel').find('.member_fname').val());

            $('#view_lastname').val($(this).closest('.member_action_panel').find('.member_lname').val());

            $('#view_member_email').val($(this).closest('.member_action_panel').find('.member_email').val());

            $('#view_contact_no').val($(this).closest('.member_action_panel').find('.member_mobile_no').val());

            $('#view_datebirth').val($(this).closest('.member_action_panel').find('.member_dob').val());
            ...
            $('#view_password').val($(this).closest('.member_action_panel').find('.member_relationship').val());
            
            $('#view_member_id').val($(this).closest('.member_action_panel').find('.member_id').val());
