...
@section('main_content')
                                    ...
                                    <div class="pharma-step-content">
                                       ...
                                       <div class="user-box">
                                          <div class="select-style pharma-step-drp">
                                             <select class="frm-select" name="contact_role" >
                              ...
                              <div class="col-sm-12 col-md-6 col-lg-4">
                                 <div class="pharma-step-bx">
                                    ...
                                    <div class="pharma-step-content">
                                       ...
                                       <div class="user_box">
                                          <input type="text" class="input_acct-logn" data-rule-number="true"  data-rule-minlength="11" data-rule-maxlength="11" value="{{ isset($arr_pharmacy['fax'])?$arr_pharmacy['fax']:'' }}"  name="fax" id="fax" placeholder="Fax" />
                                    ...
                                    <div class="pharma-step-content">
                                      ...
                                      <div id="other_field" style="display:none">
                                       <div class="user_box">
                                           ...
                                           <div class="select-style pharma-step-drp">
                                             <select class="frm-select" name="other_group">
  ...
  $('#frm_profile_step1_id').on('submit',function()
  {
        var form   = $(this);
  ...
  $(document).ready(function() 
  {
        $("#profile_step1_id").click(function() {
             showProcessingOverlay();
