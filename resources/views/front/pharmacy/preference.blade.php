         ...
         <div class="row">
            ...
            <div class="col-sm-12 col-md-9 col-lg-10">
               <div class="das-middle-content">
                  ...
                  <form action="{{ $module_url_path }}/preference/create" method="post" name="frm_pharmacy_pref" id="frm_pharmacy_pref">
                  {{ csrf_field() }}
                                   ...
                                   <div class="pharma-step-bx" style="min-height:360px!important;">
                                      <div class="pharma-step-content">
                                         ...
                                         <h5>(Please select any preference to recevied notification.)</h5>
                                          <div class="check-box pharmacy-signup2 pharmacy_pref">
                                         ...
                                         <div class="check-box pharmacy-signup2 pharmacy_pref">
                                          ...
                                          <div class="check-box pharmacy-signup2 pharmacy_pref">
                                            ...
                                            <span class="err" id="err_phar_prefernces"></span>
                                    </div>
...
<script>
    ...
    $(document).ready(function()
    {
     ...
     $('#frm_pharmacy_pref').submit(function()
        {
             
                if($('.pharmacy_pref').find('input[type=checkbox]:checked').length == 0)
                {
                   $('#err_phar_prefernces').html('Please select atleast one checkbox.');
                   return false;
                }
                else
                {
