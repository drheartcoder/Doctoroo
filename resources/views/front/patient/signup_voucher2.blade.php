...
<div id="signup_voucher" class="modal fade" tabindex="-1" data-replace="true" style="display: none;">
   <div class="modal-dialog loign-insw">
      <!-- Modal content-->
      <div class="modal-content logincont">
         <div class="modal-header head-loibg">
            <button type="button" class="login_close close" data-dismiss="modal"><img src="https://www.doctoroo.com.au/images/close-popup.png" alt=""></button>
         </div>
         <div class="modal-body bdy-pading">
         <form name="frm_patient_signup_voucher" id="frm_patient_signup_voucher" method="post" action="https://www.doctoroo.com.au/patient/signup_voucher/store">
         {{ csrf_field() }}
            <div class="login_box signup2">
               ...
               <div class="user_box">
                ...
                <div class="user_box">
                  <input type="text" class="input_acct-logn" value="" placeholder="Enter Friends code" name="friends_code" id="friends_code" />
...
<script src="https://www.doctoroo.com.au/js/geolocator/jquery.geocomplete.min.js"></script>
<script>
   ...
   $(document).ready(function(){
      ...
      $('#vemail').on('blur',function(){
            ...
            if($.trim(vemail)!='')
            {
               ...
               $.ajax({
                     url   : "https://www.doctoroo.com.au/patient/duplicate/email",
                     type : "POST",
                     dataType:'json',
      ...
      $('#patient_signup_voucher').click(function()
      {
         ...
         else
         {
            ...
            $.ajax({
               url:'https://www.doctoroo.com.au/patient/signup_voucher/store',
               type:'POST',
               dataType:'json',
               ...
               success:function(res){
                  ...
                  else if(res.response == 'exist')
                  {
                     hideProcessingOverlay();
                     //window.loaction.href = "https://www.doctoroo.com.au/patient/error";
                  }
               }
            });
         }
      ...
      $('#friends_code').on('blur',function(){
         ...
         if($.trim(friends_code) != '')
         {
            var token = $('input[name="_token"]').val();
            $.ajax({
                  url   : "https://www.doctoroo.com.au/patient/check_code/friends_code",
                  type : "POST",
                  dataType:'json',
