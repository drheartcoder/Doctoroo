            ...
            <div class="sub-header  z-depth-2">
                <div class="row detInfo">
                    <div class="col s6 m6 l6 left-align">
                        <div class="data">
                            <label class="white-text">Arnoldian Jackson </label>
                            <small>Patient Name</small>
                        </div>
                        <div class="data">
                            <label class="white-text">Dr. Jonathan Smithonian</label>
                    ...
                    <div class="col s6 m6 l6 right-align">
                        ...
                        <a class="view-invoice white-text" href="{{ url('/patient') }}/consultation_invoice">View Invoice <span><i class="material-icons">&#xE873;</i></span></a>
                    </div>
                </div>
