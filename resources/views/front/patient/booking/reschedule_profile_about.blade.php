...
<div class="has-header profile mar300">
   <div class="container">
    ...
    <div class="tabli scrollspy  z-depth-2">
        <ul>
            <li class="active">
                <a href="{{ url('/patient') }}/booking/reschedule/profile_about/{{ $enc_booking_id }}/{{$enc_doctor_id}}" class="valign-wrapper">About Me</a>
            </li>
            <li>
                <a href="{{ url('/patient') }}/booking/reschedule_consultation/{{ $enc_booking_id }}" class="valign-wrapper">Availibility</a>
            </li>
        </ul>
    </div>
