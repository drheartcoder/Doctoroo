    ...
    <div class="mar300  has-header has-footer">
        ...
        <div class="consultation-tabs">
            <ul class="tabs tabs-fixed-width">
                <li class="tab col s3" >
                    <a class="active" href="{{ url('/') }}/patient/dashboard"><span><img src="{{ url('/') }}/public/new/images/new-doc-icon.png" alt="icon"/> </span> New</a></li>
                <li class="tab col s3">
        ...
        @if(isset($new_consult_arr) && !empty($new_consult_arr))
        ...
        @endif
            <div id="test1" class="col s12 tab-content medi">
                <div class="available-now martp consultation_lists">

                    @if(isset($new_consult_arr) && !empty($new_consult_arr))
                        <ul class="collection brdrtopsd">
                            @foreach($new_consult_arr as $new_consult_data)
                                <li class="collection-item valign-wrapper">
                                    ...
                                    @php
                                        ...
                                        {
                                            $profile_images = $doctor_image_url.$new_consult_data['doctor_user_details']['profile_image'];
                                        ...
                                        $consult_datetime = convert_utc_to_userdatetime($patient_id, "patient", $new_consult_data["consultation_datetime"]);
                                    @endphp
                    ...
                    @else
                        <div class="my-con-bx">
                            <div class="doc-img">
                                ...
                                <p class="no-data">Seeking for doctor. Book a new consultation.</p>
                            </div>
                        </div>
                    @endif
