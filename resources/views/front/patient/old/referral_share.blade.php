      ...
      <div class="modal-content share-link-modal">
         ...
         <div class="modal-body bdy-pading">
            <div class="login_box signup2">
               ...
               {{-- <div class="login-bts round-btn">
                   <a href="" class="btn btn-search-login" id="share_referral" >Share Link</a>
                   <button class="btn btn-search-login" value="submit">Share Link</button>
               </div> --}}
