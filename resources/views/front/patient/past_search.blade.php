...
@section('main_content')
    ...
    <div class="header bookhead ">
        ...
        <div class="searchicon">
            {{-- <a href="{{ url('/patient') }}/past_search" class="menu-icon center-align"><i class="material-icons">search</i> </a> --}}
                    ...
                    <ul class="collection brdrtopsd">
                        @foreach($past_consult_arr['data'] as $past_consult_data)
                            <li class="collection-item valign-wrapper">
                                ...
                                <?php $consult_datetime = convert_utc_to_userdatetime($patient_id, "patient", $past_consult_data["consultation_datetime"]); ?>
