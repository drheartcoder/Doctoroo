...
<div class="header z-depth-2 bookhead">
    ...
    <div class="mar300 has-header has-footer">
        ...
        @else
        <br><h5 class="center-align no-data">There is no payment method added yet.</h5>
        @endif 
...
<div id="edit_view_method" class="modal requestbooking">
    <form id="payment_method_form">
        ...
        <div class="modal-footer center-align">
            <a class="modal-close modal-action waves-effect waves-green btn-cancel-cons full-width-btn">Close</a>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.view_payment_details').click(function(e){
            ...
            //$('#edit_cvv').val(cvv).prop('readonly',true);
        ...
        $('.edit_payment_details').click(function(){
            ...
            //$('#edit_cvv').val(cvv).prop('readonly',false);
    ...
    $('#edit_card_no').val(number);          
        ...
        $('#btn_delete_method').click(function(e){
            ...
            $.ajax({
              url:'{{ url("/") }}/patient/setting/card/delete',
              type:'post',
              dataType: 'json',
