        ...
        <div class="medi">
            <ul class="tabs tabli nomr z-depth-2 tabs-fixed-width">
                <li class="tab truncate">
                    <a href="{{ url('/') }}/patient/setting/disputes" class="redirect_new">New Disputes</a>
                </li>
                <li class="tab truncate">
                    <a href="{{ url('/') }}/patient/setting/disputes/open" class="redirect_open">Open Disputes</a>
                </li>
                <li class="tab truncate">
                    <a href="{{ url('/') }}/patient/setting/disputes/closed" class="active redirect_closed">Closed Disputes</a>
                </li>
            </ul>
            <div class="clear"></div>
