                ...
                <div class="services-block">
                    ...
                    <div class="row">
                        <div class="col s4 m4 l4">
                            <ul>
                                <li><a href="#">After hours home Doctor </a></li>
                                <li><a href="#"> Online Doctor Consultations </a></li>
                                <li><a href="#"> Online Doctors  </a></li>
                                <li><a href="#"> Online Doctor Prescriptions   </a></li>
                                <li><a href="#"> See a Doctor at Home </a></li>
                                <li><a href="#"> Talk to a Doctor Online  </a></li>
                            </ul>
                        </div>
                        <div class="col s4 m4 l4">
                            <ul>
                                <li><a href="#">Chat With a Doctor </a></li>
                                <li><a href="#">OnLine Doctors Australia</a></li>
                                <li><a href="#"> Dial a Doctor on Demand</a></li>
                                <li><a href="#">Book a Doctor Online in Australia</a></li>
                                <li><a href="#">See a GP Online</a></li>
                                <li><a href="#">Home Doctor Service Online</a></li>
                            </ul>
                        </div>
                        <div class="col s4 m4 l4">
                            <ul>
                                <li><a href="#">Get a Sick Note &amp; Doctor's Certificate </a></li>
                                <li><a href="#">Homepage Doctoroo</a></li>
                                <li><a href="#">See a Doctor at Home,without Travelling Anywhere</a></li>
