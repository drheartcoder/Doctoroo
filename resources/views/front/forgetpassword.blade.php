         ...
         <div class="modal-body bdy-pading">
               ...
               <div class="login_box">
                 ...
                 <div class="alert-box alert_error alert-dismissible" id="forget_password_error_msg_mob_no" style="display: none;">
                  ...
                  <div class="forget-txt">Forgot your password? Please enter your registered email id.
                  </div>
                  <div class="user_box">
                     <input type="text" name="mobile_no_forget" class="input_acct-logn signp" id="mobile_no_forget" placeholder="Enter email id" />
  ...
  /*$('#mobile_no_forget').keydown(function(){
   ...
   function forgetPasswordValidationCheck()
   {
        ...
        if($.trim(mobile_no_forget)=='')
        {
           ...
           $('#err_mobile_no_forget').html('Please enter email.');
           $('#err_mobile_no_forget').fadeOut(4000);
           flag  = 1;
        }
        else if(!vemail_filter.test(mobile_no_forget))
        {
          $('#err_mobile_no_forget').show();
          $('#mobile_no_forget').focus();
          $('#err_mobile_no_forget').html('Invalid email, enter a valid email id');
          $('#err_mobile_no_forget').fadeOut(4000);
          flag  = 1;
        }
