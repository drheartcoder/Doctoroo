...
<script src="//static.opentok.com/webrtc/v2.2/js/opentok.min.js"></script>
  ...
  <div class="container bump-me">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td><img src="{{ path }}/public/images/archiving-on-message.png"></td>
              </tr>
              <tr>
                <td style="vertical-align: middle;">Archiving remains on</td>
                <td><img src="{{ path }}/public/images/archiving-on-idle.png"></td>
              </tr>
              <tr>
                <td style="vertical-align: middle;">Archiving is stopped</td>
                <td><img src="{{ path }}/public/images/archiving-off.png"></td>
              </tr>
            </tbody>
          </table>
      </div>
    ...
    <script src="{{ path }}/public/js/host.js"></script>
