        ...
        <div class="box-content">
          ...
          <div class="btn-toolbar pull-right clearfix">
            ...
            <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" 
               ...
               href="{{ $module_url_path }}/verifiedpharmacies"
               ...
               <tbody>
                  @if(count($arr_pharmacy)>0)
                   ...
                   <tr>
                      ...
                      <td>
                         <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/edit/'.base64_encode($pharmacy['userinfo']['id']) }}"  title="Edit Pharmacy">
