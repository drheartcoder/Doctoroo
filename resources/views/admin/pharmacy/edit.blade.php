             ...
             if($.trim(contact_role)=="")
             {
                ...
                $('html, body').animate({
                      scrollTop: $('#main-content').offset().top
                                   ...
                                   $(".close").click();  $('#contact_role').focus();
                return false;
             }
             ...
             if($.trim(pharmacy_name)=="")
             {
                ...
                $('html, body').animate({
                      scrollTop: $('#main-content').offset().top
                                   ...
                                   $(".close").click();  $('#pharmacy_name').focus();
                return false;
             }
             if($.trim(contactnumber)=="")
             {
                ...
                $('html, body').animate({
                      scrollTop: $('#main-content').offset().top
                                   ...
                                   $(".close").click();  $('#contactnumber').focus();
                return false;
             }
