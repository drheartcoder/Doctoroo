            ...
            <div class="box box-blue">
                ...
                <div class="box-content">
                    @include('admin.layout._operation_status')
                      ...
                      <form method="post" action="{{ url($module_url_path.'/store')}}" class="form-horizontal" enctype="multipart/form-data" id="validation-form">
                      {{ csrf_field() }}
                          ...
                          <div class="col-sm-9 col-lg-2 controls">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                     <img src="{{url('/')}}/public/images/no-image.png" alt="Doctroo"/>
                                 </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                             <input type="text" name="title" id="title" class="form-control" data-rule-required="true" data-rule-maxlength="255" placeholder="Title">   
                         ...
                         <div class="form-group">
                          <label class="col-sm-3 col-lg-2 control-label" for="page_desc">Description <i class="red">*</i></label>
                           <div class="col-sm-6 col-lg-8 controls">
                               <textarea name="description" placeholder="Description" id="description" class="form-control" data-rule-required="true"> </textarea>                
