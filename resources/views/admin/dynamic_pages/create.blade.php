      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-content">
            ...
            <form method="post" action="{{url($module_url_path.'/store')}}" id="validation-form" class="form-horizontal">
            {{ csrf_field() }}
              <div class="form-group">
                  <label class="col-sm-3 col-lg-2 control-label" for="page_title">Page Name
                       <i class="red">*</i>
                       
                  </label>
                  <div class="col-sm-6 col-lg-4 controls">
                    <input type="text" name="page_name" placeholder="Page Name" id="page_name" class="form-control" data-rule-required="true" data-rule-maxlength="255">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    <input type="text" name="page_title" placeholder="Page Title" id="page_title" class="form-control" data-rule-required="true" data-rule-maxlength="255">
                ...
                <div class="form-group">
                  <label class="col-sm-3 col-lg-2 control-label" for="page_desc">Page Content
                   ...
                   <div class="col-sm-6 col-lg-8 controls">
                       <textarea name="page_desc" placeholder="Page Content" id="page_desc" class="form-control" data-rule-required="true"> </textarea>                
