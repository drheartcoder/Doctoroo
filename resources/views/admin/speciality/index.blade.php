    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="btn-group">
          <a href="{{ $module_url_path.'/create'}}" class="btn btn-primary btn-add-new-records"  title="Add CMS">Add Doctor Speciality</a> 
          </div>
          ...
          <div class="table-responsive" style="border:0">
            ...
            <input type="hidden" name="multi_action" value="" />
              ...
              <table class="table table-advance"  id="speciaity-table" >
               <thead>
                  <tr>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td> {{ isset($page['speciality'])?$page['speciality']:'' }}</td> 
                     
                     <td>
               
                     @if(isset($page['image']) && !empty($page['image']))
                      <img src="{{$speciality_img_url_path}}/{{$page['image']}}" width="30px" height="30px">
                     @endif

                                         

                     <td>
                        @if($page['speciality_status']=="Active")
