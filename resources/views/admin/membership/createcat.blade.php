...
<div class="col-md-12">
   <div class="box box-blue">
      ...
      <br/>
      <form method="post" action="{{url($module_url_path.'/storecategory')}}" id="validation-form" class="form-horizontal" enctype="multipart/form-data" name="Form" >
         {{ csrf_field() }}
                  ...
                  <div class="box-content">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="category" class="form-control" id="cat" placeholder="Category" >
