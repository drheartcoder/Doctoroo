...
<div id="breadcrumbs">
   <ul class="breadcrumb">
      ...
      <li class="active">{{isset($module_title)? 'Patient '.$module_title:'Patient Mobile Number Change Request'}}</li>
   </ul>
</div>
<!-- END Breadcrumb -->
<!-- BEGIN Main Content -->
   ...
   <div class="box">
      <div class="box-title">
         <h3>
            ...
            {{isset($module_title)? 'Patient '.$module_title:'Patient Mobile Number Change Request'}}
         </h3>
         <div class="box-tool">
               ...
               <table class="table table-advance"  id="invitation_table" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="btn  btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/doctor/accept_request/'.base64_encode(0).'/'.base64_encode($data['patient_id']).'/'.base64_encode($data['new_phone_no']).'/'.base64_encode($data['new_country_code'])}}" 
