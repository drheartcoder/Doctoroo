         ...
         <div class="box-content">
            ...
            <form method="post" action="{{$module_url_path.'/update/'.$enc_id}}" id="validation-form" class="form-horizontal" name="Form" >
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                     <select class="form-control" name="faq_cat" data-rule-required="true">
                           ...
                           @foreach($faq_cats as $val)
                              @if($val['id'] == $data_info['category_id'])
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls"> 
                     <input type="text" name="question" id="question"  value="{{isset($data_info['question'])?$data_info['question']:''}}" placeholder="Question" class="form-control" data-rule-required="true" data-rule-maxlength="255">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    <textarea name="answer"  id="answer" rows="4" cols="50" class="form-control" data-rule-required="true">{{isset($data_info['answer'])?$data_info['answer']:''}}</textarea>
