    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <span class="divider">
                ...
                <a href="{{ $module_url_path }}">Invitation</a>
            </span> 
            <span class="divider">
                <i class="fa fa-angle-right"></i>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="btn-group">
          <a href="{{ $module_url_path.'/create'}}" class="btn btn-primary btn-add-new-records"  title="Add CMS">Add Doctor Application</a> 
          </div>
              ...
              <table class="table table-advance"  id="speciaity-table" >
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td> 
                       <!--  <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href=""  title="Edit">
                        <i class="fa fa-edit" ></i>
                        </a>  
                        &nbsp;  
                        <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="" 
