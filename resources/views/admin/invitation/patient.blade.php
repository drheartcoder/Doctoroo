...
<div id="breadcrumbs">
   <ul class="breadcrumb">
      ...
      <li class="active">{{isset($module_title)? 'Patient '.$module_title:'Patient Invitation'}}</li>
   </ul>
</div>
<!-- END Breadcrumb -->
<!-- BEGIN Main Content -->
   ...
   <div class="box">
      <div class="box-title">
         <h3>
            ...
            {{isset($module_title)? 'Patient '.$module_title:'Patient Invitation'}}
         </h3>
         <div class="box-tool">
      ...
      <div class="box-content">
         ...
         <form method="post" class="form-horizontal" id="frm_manage" action="{{url($module_url_path.'/patient/multi_action')}}">
            {{csrf_field()}}
            <div class="col-md-10">
               ...
               <table class="table table-advance"  id="invitation_table" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/patient/delete/'.base64_encode($data['id'])}}" 
