...
<link rel="stylesheet" href="{{ url('/') }}/public/assets/data-tables/latest/dataTables.bootstrap.min.css">
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">{{isset($module_title)? 'Pharmacy '.$module_title:'Pharmacies Invitations'}}</li>
        </ul>
    </div>
    <!-- END Breadcrumb -->
   ...
   <div class="box">
        <div class="box-title">
           <h3>
              ...
              {{isset($module_title)? 'Pharmacy '.$module_title:'Pharmacy Invitations'}}
           </h3>
           <div class="box-tool">
        ...
        <div class="box-content">
           ...
           <form method="post" class="form-horizontal" id="frm_manage" action="{{url($module_url_path.'/pharmacy/multi_action')}}">
              {{csrf_field()}}
              <div class="col-md-10">
                 ...
                 <table class="table table-advance"  id="pharmacy_invitation_table" >
                    ...
                    <tbody>
                       ...
                       <tr>
                          ...
                          <td>
                             <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/pharmacy/delete/'.base64_encode($data['id'])}}" 
